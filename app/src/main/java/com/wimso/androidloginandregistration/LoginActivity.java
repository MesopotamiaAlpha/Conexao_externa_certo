...
public class LoginActivity extends AppCompatActivity {
    ...
    void loginAct() {
        ...
        if(TextUtils.isEmpty(email)) {
            emailText.setError("O email nao pode ficar vazio!");
            return;
        }

        if(TextUtils.isEmpty(password)) {
            passwordText.setError("A senha nao pode ficar vazia");
            return;
        }
        ...
        loginService.doLogin(email, password, new Callback() {
            ...
            public void onFailure(Call call, Throwable t) {
                Toast.makeText(LoginActivity.this, "Um erro ocorreu!", Toast.LENGTH_SHORT).show();
            }
        });
    }
